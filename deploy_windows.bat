...
cls
echo ========================================================
echo   ZipLoot Cloudflare AI Bot Studio Automated Installer
echo ========================================================
echo.
...
echo.
echo [3/3] Building and Deploying Serverless AI Worker to Cloudflare...
cmd.exe /c "npx -y wrangler deploy worker.js --name cloudflare-ai-bot-studio"

echo.
echo ========================================================
echo [SUCCESS] Cloudflare Worker Deployed Automatically!
echo Launching Local Studio UI in Browser...
echo ========================================================
python app.py
